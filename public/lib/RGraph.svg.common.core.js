        ...
        //
            ...
            for (var i=0; i<prop.yaxisLabels.length; ++i) {
                ...
                var segment = (obj.graphHeight - (prop.marginInnerTop || 0) - (prop.marginInnerBottom || 0) ) / prop.yaxisLabels.length,
                    ...
                    x       = prop.marginLeft - 7 - (prop.yaxisLinewidth || 1) + prop.yaxisLabelsOffsetx,
                    halign  = 'right';
                
                if (prop.yaxisPosition === 'right') {
                    halign = 'left';
                    x      = obj.width - prop.marginRight + 7 + (prop.yaxisLinewidth || 1) + prop.yaxisLabelsOffsetx;
                }
    ...
    RGraph.SVG.stringsToNumbers = function (str)
    {
        ...
        if (typeof str === 'object') {
            for (var i=0,len=str.length; i<len; i+=1) {
                str[i] = RGraph.SVG.stringsToNumbers(str[i]);
            }
        }
